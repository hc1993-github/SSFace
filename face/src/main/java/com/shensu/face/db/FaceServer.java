...
import com.shensu.face.util.ErrorCodeUtil;
    ...
    public CompareResult searchFaceFeature(FaceFeature faceFeature, FaceEngine faceEngine) {
        ...
        try {
            ...
            if (searchResult != null) {
                ...
                FaceEntity faceEntity = FaceDatabase.getInstance(context.getApplicationContext()).faceDao().queryByFaceId(faceFeatureInfo.getSearchId());
                if (faceEntity != null) {
