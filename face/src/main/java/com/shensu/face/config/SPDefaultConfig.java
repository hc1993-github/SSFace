...
//        return getBoolean(context, R.string.preference_recognize_keep_max_face, false);
    ...
    public static String getAppId(Context context) {
        return getString(context, R.string.preference_app_id, ApplyConfig.APP_ID);
    }

    public static String getSdkKey(Context context) {
        return getString(context, R.string.preference_sdk_key, ApplyConfig.SDK_KEY);
    }

    public static String getActiveKey(Context context) {
        return getString(context, R.string.preference_active_key, ApplyConfig.ACTIVE_KEY);
    }
