...
public class RecognizeConfiguration {
    ...
    //demo不实现所有配置，若以下项也需要进行自定义配置，可参考其他配置项实现
    public static class Builder {
        ...
        private float imageQualityNoMaskRecognizeThreshold = SPDefaultConfig.IMAGE_QUALITY_NO_MASK_RECOGNIZE_THRESHOLD;
        private float imageQualityMaskRecognizeThreshold = SPDefaultConfig.IMAGE_QUALITY_MASK_RECOGNIZE_THRESHOLD;
